...
import { CREATE_POST, UPDATE_POST, DELETE_POST, SET_POSTS, IPostActionTypes } from './types';
...
const Actions = {
    ...
    fetchCreatePost: (title, body) => (dispatch): Promise<void> => {
        return postApi.createPost(title, body).then((response) => {
